<?php
    // post detail transaksi produk outdoor
    include "../../koneksi.php";
    if($_SERVER['REQUEST_METHOD']=="POST"){
        ...
        $ukuran_cetak       = $panjang."m x ".$lebar."m";
        ...
        if($nama_transaksi == NULL || $panjang == "0" || $lebar == "0" || $quantity == NULL || $quantity == "0" || $jenis_bahan == "0" || $total_cetak == NULL || $jasa_design == "0" || $total_harga == NULL){
            header("location:../v_dtransaksi_add_outdoor.php?id=$id_transaksi&ps=transaksi_kurang");
        }else{
            // if($jasa_design == "Ya"){
            ...
            //     mysqli_query($koneksi, "INSERT INTO jasa_design(id_design,id_dtransaksi,id_user,tanggal_cetak,waktu_mulai,waktu_selesai,waktu_total,status_cetak) 
            //     VALUES('$id_design','$id_dtransaksi','$id_user','$tanggal_cetak','$waktu_mulai','$waktu_selesai','$waktu_total','$status_cetak')");
