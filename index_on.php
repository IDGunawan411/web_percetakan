...
<div class="login-box">
    <div class="card card-outline card-dark shadow-lg bg-white p-2">
        <div class="card-header text-center bgcard">
            <h3 class="text-center">#<a class="text-danger">Selamat</a> Datang</h3>
        </div>
        <div class="card-body">
            <p class="text-center mb-4">Sign in to start your session</p>
            <form action="cek_login_on.php" method="post">
                <div class="input-group mb-3">
                    <input type="text" class="form-control border-right-0" placeholder="Masukan Email" name="email" id="email" value="<?php if(isset($_GET['us'])){echo $_GET['us'];}?>">
