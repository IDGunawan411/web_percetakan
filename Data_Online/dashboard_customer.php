            ...
            <div class="row content-header border shadow-sm">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-md-right">
                        <li class="breadcrumb-item">Dashboard Customer</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                ...
                <!-- Jumlah Transaksi -->
                <?php
                    $dt  = mysqli_query($koneksi, "SELECT COUNT(id_transaksi) as jumlah_transaksi FROM transaksi where id_customer = '$_SESSION[id_customer]'");
